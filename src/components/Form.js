...
Form.propTypes = {
  ...
  activitiesInput: PropTypes.string.isRequired,
  setActivitiesInput: PropTypes.func.isRequired,
  locationsInput: PropTypes.string.isRequired,
  setLocationsInput: PropTypes.func.isRequired,
  notesInput: PropTypes.string.isRequired,
  setNotesInput: PropTypes.func.isRequired,
  setImageUploads: PropTypes.func.isRequired,
  imgPreview: PropTypes.array.isRequired,
  setImgPreview: PropTypes.func.isRequired,
};
